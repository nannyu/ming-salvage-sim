...
- 网页版可玩界面：地图、国势、大臣列表、召见聊天、诏令草案、颁诏结算，并配人物头像（专属或预设池）。
- 网页端后宫：单独的后宫面板可浏览在册妃嫔、查看选妃候选、册封入宫，并随时一键重开新局。
- 纯文本 CLI：方便快速调试和跑局。
...
- 建筑系统：御窑厂、边堡、仓储、工坊、河工等建筑有等级、状态、维护费与产出，按月自动落账；新建或扩建须立项推进，事项跑完才落地。
